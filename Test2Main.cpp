...
void Test2Main::CreateRenderers(const std::shared_ptr<DX::DeviceResources>& deviceResources)
{
...
void Test2Main::OnWindowSizeChanged()
{
...
void Test2Main::OnDeviceRemoved()
{
